...
ref = require('../../actions/demographics/pyramid-actions.js'), mouseOver = ref.mouseOver, toggleCategory = ref.toggleCategory, addFilter = ref.addFilter, toggleOutlineCategory = ref.toggleOutlineCategory, toggleValue = ref.toggleValue, removeFilter = ref.removeFilter, toggleOutlineValue = ref.toggleOutlineValue, requestPyramidData = ref.requestPyramidData, fetchPyramidData = ref.fetchPyramidData, districtSearch = ref.districtSearch, controlsOpened = ref.controlsOpened, controlsClosed = ref.controlsClosed;
