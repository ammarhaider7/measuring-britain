...
var $, BarsComponent, ControlsNew, React, category_options, data, drawRelBars, value_options;
      ...
      return $(window).on('scroll', (function(_this) {
        return function() {
          ...
          if ((docHeight - docScrollTop) < sunburstOffsetTop) {
            ...
            $(window).off('scroll');
            return _this.props.fetchBarsData(null);
          }
        };
      })(this));
    }
...
//# sourceMappingURL=religon-bars-component.map
