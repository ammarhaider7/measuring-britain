...
parse = function(dataArray) {
  var ages, d3ReadyData, femaleObs, females, femalesPerc, femalesPercFormat, maleObs, males, malesPerc, malesPercFormat, sum, totalArr, utils;
  ...
  utils = {
    ...
    percArrayFormat: function(array, sum) {
      return array.map(function(num) {
        return num / sum;
      });
    }
  ...
  d3ReadyData = {
    ...
    malesPercFormat: malesPercFormat,
    femalesPercFormat: femalesPercFormat
  };
  return d3ReadyData;
};
