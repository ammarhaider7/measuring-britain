...
var CONTROLS_CLOSED, CONTROLS_OPENED, DISTRICT_SEARCH, ERROR_RECEIVE_RELIGION_DATA, FILTER_USED, INIT_BARS, INIT_BARS_OFF, INIT_DONE, MOUSE_OVER, RECEIVE_RELIGION_DATA, REQUEST_RELIGION_DATA, TOGGLE_CATEGORY, TOGGLE_VALUE, genHealthInitState, objectAssign, ref, stackedAreaChart;
...
stackedAreaChart = function(state, action) {
  if (state == null) {
