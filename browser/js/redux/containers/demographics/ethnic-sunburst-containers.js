...
var Sunburst, SunburstComponent, connect, controlsClosed, controlsOpened, fetchSunburstData, mapDispatchToProps, mapStateToProps, mouseOver, ref, requestSunburstData, toggleCategory, toggleValue;

connect = require('react-redux').connect;

ref = require('../../actions/demographics/ethnic-sunburst-actions.js'), mouseOver = ref.mouseOver, toggleCategory = ref.toggleCategory, toggleValue = ref.toggleValue, requestSunburstData = ref.requestSunburstData, fetchSunburstData = ref.fetchSunburstData, controlsOpened = ref.controlsOpened, controlsClosed = ref.controlsClosed;
